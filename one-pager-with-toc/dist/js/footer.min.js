...
var poc=poc||{};poc.app=function(n,o){{var i,c,t;n("body")}return i=function(){},c=function(){poc.scroll.init(),t()},t=function(){var n,i,c,t=0,p=!1;n=function(){t=o.pageYOffset,i()},i=function(){p||o.requestAnimationFrame(c),p=!0},c=function(){p=!1;var n=t;poc.scroll.updateScroll(n)},o.onscroll=function(){n()}},{init:i,initOnload:c}}(jQuery,window),$(function(){poc.app.init()}),$(window).load(function(){poc.app.initOnload()});
var poc=poc||{};poc.scroll=function(t,e){var n,i,a,o,c,s,r,f,u,d,l="",v=t("body");return n=function(){i(),a(),o(e.pageYOffset),t(".js-page-banner__caption__btn").on("click",function(e){e.preventDefault();var n=t(this).attr("href");t(n).velocity("scroll",{duration:500,offset:0})})},o=function(t){c=t,updateMenu(),updateMenuItems()},i=function(){r=t("#main"),f=t("#article-nav"),s=f.offset().top},updateMenu=function(){c>s?r.addClass("main--fixed"):r.removeClass("main--fixed")},a=function(){u=f.find(".js-article-nav__item"),d=u.map(function(){var e=t(this),n=t(e.attr("href")),i=n.offset().top;return n.length?{$item:n,offset:i}:void 0}),u.on("click",function(e){e.preventDefault();var n=t(this).attr("href");t(n).velocity("scroll",{duration:500,offset:0})})},updateMenuItems=function(){var e;e=d.map(function(){return this.offset<c+50?this.$item:void 0}),e=e[e.length-1];var n=e&&e.length?e[0].id:"";""===n&&t("#section_1").addClass("section--fixed"),l!==n&&(l=n,u.removeClass("article-nav__item--active"),u.filter("[href=#"+n+"]").addClass("article-nav__item--active"),t(".js-section").removeClass("section--fixed"),$newSection=t("#"+n),$newSection.addClass("section--fixed"),v.css("background",$newSection.data("background")))},{init:n,updateScroll:o}}(jQuery,window);